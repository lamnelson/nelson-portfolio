...
import type { ExperienceItem } from "../Journey.types";
import { calculateExperienceDuration, formatExperienceDate } from "../Journey.utils";
import { ExperienceDescription } from "./JourneyDescription";
